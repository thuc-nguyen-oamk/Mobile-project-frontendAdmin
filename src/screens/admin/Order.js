...
export default function Order() {
  ...
  const element = (data, index) => (
      ...
      <Button title="Received" disabled={data[6] === "Received" ?true : false} size={24} onPress={() => updateStatus(data,"Received",index)} />
      <Button title="Preparing" disabled={data[6] === "Preparing" ?true : false} size={24} onPress={() => updateStatus(data,"Preparing",index)} />
      <Button title="Delivering" disabled={data[6] === "Delivering" ?true : false} size={24} onPress={() => updateStatus(data,"Delivering",index)} />
      <Button title="Closed" disabled={data[6] === "Closed" ?true : false} size={24} onPress={() => updateStatus(data,"Closed",index)} />
    </View>
